...
async function suggestion_conversation(){
    var id = localStorage.getItem("id");
    fetch("http://hms12432.hostmyservers.me/api/v1/compte/")
...
function openConversation() {
    ...
    fetch('http://hms12432.hostmyservers.me/api/v1/email/'+contact)
    .then(res => res.json())
    .then(data => {
        console.log(data)
        if(data.message == ' '){
            ...
            fetch("http://hms12432.hostmyservers.me/api/v1/new-conv/", {
                method: 'POST',
                headers: {
                    id:id,
                    emailR:contact
